...
public class MyRSA {
    ...
    static {
        keyMap.put(PUBLIC_KEY, decryptBASE64(KeyStore.PUBLIC));
        keyMap.put(PRIVATE_KEY, decryptBASE64(KeyStore.PRIVATE));
    }

    public static String decoded(String encodedText){
        PrivateKey privateKey = restorePrivateKey(keyMap.get(PRIVATE_KEY));
        return RSADecode(privateKey, decryptBASE64(encodedText));
    }
